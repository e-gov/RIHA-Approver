...
public class IssueController {
    ...
    @ApiOperation("List all information system issues")
    @ApiPageableAndFilterableParams
    ...
    /**
     * Retrieve single issues by id.
     *
     * @param infoSystemUuid info system UUID
     * @param issueId     id of an issue
     * @return issue or null
     */
    @GetMapping("/systems/{infoSystemUuid}/issues/{issueId}")
    @ApiOperation("Get single information system issue")
    public ResponseEntity<Issue> getInfoSystemIssue(@PathVariable("infoSystemUuid") UUID infoSystemUuid,
    ...
    @ApiOperation("Create new information system issue")
    ...
    /**
     * Update single info system issue status.
     *
     * @param infoSystemUuid info system UUID
     * @param issueId     id of an issue
     ...
     */
    @PutMapping("/systems/{infoSystemUuid}/issues/{issueId}/status")
    @ApiOperation("Update information system status")
    public ResponseEntity<Issue> updateStatus(@PathVariable("infoSystemUuid") UUID infoSystemUuid,
                                              @PathVariable("issueId") Long issueId,
                                              @RequestBody IssueStatus status) {
        return ResponseEntity.ok(issueService.updateInfoSystemIssueStatus(infoSystemUuid, issueId, status));
    }
